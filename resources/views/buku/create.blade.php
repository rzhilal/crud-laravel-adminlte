                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('jumlah_buku') is-invalid @enderror" id="exampleInputName" placeholder="Jumlah Buku" name="jumlah_buku" value="{{old('jumlah_buku')}}">
                            @error('jumlah_buku') <span class="text-danger">{{$message}}</span> @enderror
                        </div>

                        <div class="form-group">
                            <label for="exampleInputName">Penulis</label>
                            <input type="text" class="form-control @error('penulis') is-invalid @enderror" id="exampleInputName" placeholder="Nama Penulis" name="penulis" value="{{old('penulis')}}">
                            @error('penulis') <span class="text-danger">{{$message}}</span> @enderror
                        </div>

                        <div class="form-group">
                            <label for="exampleInputName">Penerbit</label>
                            <input type="text" class="form-control @error('penerbit') is-invalid @enderror" id="exampleInputName" placeholder="Penerbit" name="penerbit" value="{{old('penerbit')}}">
                            @error('penerbit') <span class="text-danger">{{$message}}</span> @enderror
                        </div>
                        
                        <div class="form-group">
                            <label for="exampleInputName">Jenis Buku</label>
                            <input type="text" class="form-control @error('jenis_buku') is-invalid @enderror" id="exampleInputName" placeholder="Jenis Buku" name="jenis_buku" value="{{old('jenis_buku')}}">
